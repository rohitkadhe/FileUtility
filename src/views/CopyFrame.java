...
public class CopyFrame extends JFrame implements Colors, SearchOption, Strings {
	...
	private FileUtilButton copyFilesButton = new FileUtilButton(COPYFILES);
	...
	private JLabel sourceDirectoryLabel = new JLabel(SOURCE_DIRECTORY);
	...
	private void createHorizontalGroup(GroupLayout gl_contentPane) {
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(searchQueryLabel)
						.addComponent(destinationDirectoryLabel).addComponent(sourceDirectoryLabel)
						.addComponent(searchFilterLabel))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(comboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(copyFilesButton, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(fileNameInput, GroupLayout.PREFERRED_SIZE, 230, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(sourceDirectoryInput).addComponent(destinationDirectoryInput,
												GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(browseSourceDirectoryButton, GroupLayout.PREFERRED_SIZE, 77,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(browseDestinationDirectoryButton, GroupLayout.PREFERRED_SIZE, 77,
												GroupLayout.PREFERRED_SIZE))))
	...
	private void createVerticalGroup(GroupLayout gl_contentPane) {
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(22)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(searchQueryLabel)
								.addComponent(fileNameInput, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(19)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(sourceDirectoryInput, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(browseSourceDirectoryButton, GroupLayout.PREFERRED_SIZE,
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(destinationDirectoryLabel, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(destinationDirectoryInput, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(browseDestinationDirectoryButton, GroupLayout.PREFERRED_SIZE, 21,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(searchFilterLabel)
								.addComponent(comboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addComponent(copyFilesButton, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
	}
	...
	public void setCopyButtonListener(ActionListener al) {
		copyFilesButton.setListenser(al);
	}
